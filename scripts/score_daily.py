"""Daily jump-scoring, forecasting, and pricing-policy job (Week 2 Phase 5).
...
def main() -> int:
    ...
    try:
        ...
        print("Pulling jump-model feature data...", file=sys.stderr)
        ...
        score_date: date = jump_df["market_date"].max()
        ...
        print(f"Scoring market_date={score_date}", file=sys.stderr)
        ...
        with mlflow.start_run(run_name=run_id):
            ...
            mlflow.set_tags({"phase": "week2-phase5-daily-scoring"})
            mlflow.log_metrics(
                {
